import { Users, Smartphone, MessageSquare, Camera, Radio, Mail } from 'lucide-react';
...
const stats = [
  { icon: <Users         size={24} />, value: '12.5K', label: 'Seguidores totales' },
  { icon: <Smartphone    size={24} />, value: '4',     label: 'Redes activas'      },
  { icon: <MessageSquare size={24} />, value: '98%',   label: 'Tasa respuesta'     },
  { icon: <Camera        size={24} />, value: '340+',  label: 'Publicaciones'      },
];
...
const socialCards: SocialCard[] = [
  ...
  { href: 'https://www.tiktok.com/@solar.full.energy',                            Icon: TikTokIcon,    name: 'TikTok',              handle: '@solar.full.energy',    tag: 'Videos instalaciones', color: '#69C9D0' },
];
  ...
  <section className="animate-fadeIn">
    ...
    <div className="grid gap-5 mb-8" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}>
      {prominentButtons.map((btn) => (
        ...
        >
          <div className="flex-shrink-0"><btn.Icon width={40} height={40} fill="white" /></div>
    ...
    <div className="grid gap-5 mb-6" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))' }}>
      ...
      >
        <div style={{ color: '#818cf8', filter: 'drop-shadow(0 0 10px #818cf866)' }}>
